...
<h2>How To Use</h2>
Download the folder named "CPR RHYTHM BUILD" found at the front of the repo (you might have to just download the entire repo zip if you can't download individual folders). Inside "CPR RHYTHM BUILD" launch "Hackathon Thing.exe" to run the program.
